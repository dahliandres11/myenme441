...
# Python server code to send client an html
# User should be able to select from a set of 3 LEDs (radio buttons)
# User should be able to use a slider with values between 0-100 to change brightness level
# User should be able to use a button to submit changes to the LED brightness of the selected LED

# After button is pressed, Pi should modify given brightness level and serve a new web page that
# displays the current brightness levels for all 3 LEDs

# NOTE: Each LED should maintain its previously-set brightness level despite changing other LEDs

# Use a POST request in html form
